...
```{r}
# "The data goes back quite a long time. I'm just going to start off by looking at the last 10 years of data" ... "If I want to filter by year, I really need a `year` variable first"
...
## Extend the model to every city [17:00min]
