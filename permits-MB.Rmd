...
```{r}
# Here I'm going to create a new dataframe, where I've nested the data" ... "This is just (kind of) a useful data structure for the data that we're working with"
...
# "Then I'm going to do some tricks with mutate and some functions from the **purrr** package"...
library(purrr)
...
# ..."These are tools that let you generalise. Once you've done it for one area, how you can do it for all areas. And I'm just going to skim over that for now" [@18'00]
...
"What we've got is this plot where it's much much easier to see the long-term trend, now that we've removed those short-term"
