...
"going to treat that `month` not as a continuous variable, but as a categorical variable"

# Now, I don't believe that this is a good model. I know there's other stuff going on here. I'm just using it as a way to partition the signal into months
