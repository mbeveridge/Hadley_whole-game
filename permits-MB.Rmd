...
[@19'25] "What we've got now is this plot that [sic] it's much much easier to see the long-term trend, now that we've removed those short-term [unintelligible]. So let's just quickly recap what we're doing in this data analysis" [@19'40]

* Load in the Tidyverse
* Read in the data
* Tidying, making sure we had useful variables (eg. splitting into m&y)
* EDA, to get a quick idea (counting)
* Visualisation
* Most of the rest of the analysis was motivated by one viz, and how we could make it more useful
[@20'30]
